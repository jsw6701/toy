...
class PostServiceImplTest {
    ...
    void 게시글_상세조회() {
        ...
        PostReadDetailRequestDto requestDto = PostReadDetailRequestDto.builder()
                .postId(postId)
                .build();
    ...
    void 게시글_상세조회_실패() {
        ...
        // When & Then
        CustomException exception = assertThrows(CustomException.class, () -> postService.getPostById(requestDto));
    ...
    void 게시글_수정_실패() {
        ...
        // When & Then
        CustomException exception = assertThrows(CustomException.class, () -> postService.updatePost(requestDto));
        assertEquals(ErrorCode.POST_NOT_FOUND.getCode(), exception.getCode());
    }
